...
include("statediagram_structural.jl")
include("statediagram_gamma.jl")
include("statediagram_sge.jl")
include("statediagram_facade.jl")
include("statediagram_promotion.jl")
include("ttno_compression.jl")
include("ttno_compression_integration.jl")
include("graded_ttno_embedding.jl")
include("graded_multimode_carrier.jl")
include("fermionic_operator_algebra.jl")
include("purified_apply.jl")
