#!/usr/bin/env bash
#SBATCH --job-name=graft-mpi-checkpoint
...
#SBATCH --output=benchmark/graft-mpi-checkpoint-%j.out
...
export GRAFT_MPI_CHECKPOINT_SAMPLES_PER_RANK="${GRAFT_MPI_CHECKPOINT_SAMPLES_PER_RANK:-4}"
